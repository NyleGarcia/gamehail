...
Taken from openwave-streamdeck (same author) rather than rewritten: it is already
proven against OpenDeck's framing quirks, and a second implementation would only be a
